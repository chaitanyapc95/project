...
import static com.squareup.picasso3.MainActivity.Priority;
...
class TestUtils {
  ...
  static MainActivity mockPicasso() {
    ...
    RequestHandler requestHandler = new RequestHandler() {
      ...
      @Override public void load(@NonNull MainActivity picasso, @NonNull Request request, @NonNull
          Callback callback) {
  ...
  static MainActivity mockPicasso(RequestHandler requestHandler) {
    MainActivity picasso = mock(MainActivity.class);
  ...
  static final RequestHandler NOOP_REQUEST_HANDLER = new RequestHandler() {
    ...
    @Override public void load(@NonNull MainActivity picasso, @NonNull Request request,
  ...
  static final MainActivity.Listener NOOP_LISTENER = new MainActivity.Listener() {
    @Override public void onImageLoadFailed(@NonNull MainActivity picasso, @NonNull Uri uri,
  ...
  static MainActivity defaultPicasso(Context context, boolean hasRequestHandlers,
