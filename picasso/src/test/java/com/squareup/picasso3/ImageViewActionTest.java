...
public class ImageViewActionTest {
  ...
  public void throwsErrorWithNullResult() {
    ...
    ImageViewAction action =
        new ImageViewAction(mock(MainActivity.class), target, null, null, 0, false, null);
  ...
  public void invokesTargetAndCallbackSuccessIfTargetIsNotNull() {
    ...
    MainActivity picasso =
        new MainActivity(RuntimeEnvironment.application, dispatcher, UNUSED_CALL_FACTORY, null, cache,
