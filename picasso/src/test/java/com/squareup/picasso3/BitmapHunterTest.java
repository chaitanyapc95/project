...
import static com.squareup.picasso3.MainActivity.Priority.HIGH;
import static com.squareup.picasso3.MainActivity.Priority.LOW;
import static com.squareup.picasso3.MainActivity.Priority.NORMAL;
...
public final class BitmapHunterTest {
  ...
  @Test public void forOverrideRequest() {
    ...
    // Must use non-mock constructor because that is where MainActivity's list of handlers is created.
    MainActivity picasso =
        new MainActivity(context, dispatcher, UNUSED_CALL_FACTORY, null, cache, null, NO_TRANSFORMERS,
  ...
  @Test public void sequenceIsIncremented() {
    Action action = mockAction(URI_KEY_1, URI_1);
    MainActivity picasso = mockPicasso();
  ...
  private static class TestableBitmapHunter extends BitmapHunter {
    TestableBitmapHunter(MainActivity picasso, Dispatcher dispatcher, PlatformLruCache cache, Stats stats,
                         Action action) {
  ...
  private static class TestableRequestHandler extends RequestHandler {
    ...
    @Override public void load(@NonNull MainActivity picasso, @NonNull Request request, @NonNull Callback callback) {
      if (exception != null) {
  ...
  private static class OOMBitmapHunter extends BitmapHunter {
    OOMBitmapHunter(MainActivity picasso, Dispatcher dispatcher, PlatformLruCache cache, Stats stats,
                    Action action) {
