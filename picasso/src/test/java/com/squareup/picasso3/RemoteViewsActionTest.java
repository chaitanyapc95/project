...
import static com.squareup.picasso3.MainActivity.LoadedFrom.NETWORK;
...
public class RemoteViewsActionTest {
  ...
  private MainActivity createPicasso() {
    Dispatcher dispatcher = mock(Dispatcher.class);
    PlatformLruCache cache = new PlatformLruCache(0);
    return new MainActivity(RuntimeEnvironment.application, dispatcher, UNUSED_CALL_FACTORY, null, cache,
  ...
  static class TestableRemoteViewsAction extends RemoteViewsAction {
    TestableRemoteViewsAction(MainActivity picasso, Request data, @DrawableRes int errorResId,
