...
abstract class RemoteViewsAction extends Action {
  ...
  RemoteViewsAction(MainActivity picasso, Request data, @DrawableRes int errorResId,
  ...
  static class AppWidgetAction extends RemoteViewsAction {
    ...
    AppWidgetAction(MainActivity picasso, Request data, @DrawableRes int errorResId,
  ...
  static class NotificationAction extends RemoteViewsAction {
    ...
    NotificationAction(MainActivity picasso, Request data, @DrawableRes int errorResId,
