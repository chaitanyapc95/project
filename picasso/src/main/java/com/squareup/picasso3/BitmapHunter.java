...
class BitmapHunter implements Runnable {
  ...
  BitmapHunter(MainActivity picasso, Dispatcher dispatcher, PlatformLruCache cache,
  ...
  static BitmapHunter forRequest(MainActivity picasso, Dispatcher dispatcher,
  ...
  static Result applyTransformations(MainActivity picasso, Request data,
