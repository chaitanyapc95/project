...
/**
 * The default {@link java.util.concurrent.ExecutorService} used for new {@link MainActivity} instances.
 * <p>
...
class PicassoExecutorService extends ThreadPoolExecutor {
  ...
  private static final class PicassoFutureTask extends FutureTask<BitmapHunter>
    ...
    public int compareTo(PicassoFutureTask other) {
      MainActivity.Priority p1 = hunter.getPriority();
      MainActivity.Priority p2 = other.hunter.getPriority();
