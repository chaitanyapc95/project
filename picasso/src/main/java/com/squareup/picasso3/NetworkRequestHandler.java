...
import static com.squareup.picasso3.MainActivity.LoadedFrom.DISK;
...
final class NetworkRequestHandler extends RequestHandler {
  ...
  @Override public void load(@NonNull MainActivity picasso, @NonNull final Request request, @NonNull
  final Callback callback) {
    ...
    callFactory.newCall(callRequest).enqueue(new okhttp3.Callback() {
      @Override public void onResponse(Call call, Response response) {
        ...
        MainActivity.LoadedFrom loadedFrom = response.cacheResponse() == null ? NETWORK : DISK;
