...
/**
 * {@code RequestHandler} allows you to extend MainActivity to load images in ways that are not
 ...
 * ({@link #canHandleRequest(Request)} and {@link #load(MainActivity, Request, Callback)}) with
 * your custom logic to load images.
 * <p>
 * You should then register your {@link RequestHandler} using
 * {@link MainActivity.Builder#addRequestHandler(RequestHandler)}
 * <p>
 * <b>Note:</b> This is a beta feature. The API is subject to change in a backwards incompatible
 * way at any time.
 *
 * @see MainActivity.Builder#addRequestHandler(RequestHandler)
 */
public abstract class RequestHandler {
  /**
   * {@link Result} represents the result of a {@link #load(MainActivity, Request, Callback)} call
   * in a {@link RequestHandler}.
   *
   * @see RequestHandler
   * @see #load(MainActivity, Request, Callback)
   */
  public static final class Result {
    private final MainActivity.LoadedFrom loadedFrom;
    @Nullable private final Bitmap bitmap;
    @Nullable private final Drawable drawable;
    private final int exifRotation;

    public Result(@NonNull Bitmap bitmap, @NonNull MainActivity.LoadedFrom loadedFrom) {
    ...
    public Result(@NonNull Drawable drawable, @NonNull MainActivity.LoadedFrom loadedFrom) {
    ...
    private Result(
        ...
        @NonNull MainActivity.LoadedFrom loadedFrom,
        int exifRotation) {
      this.bitmap = bitmap;
    ...
    /**
     * Returns the resulting {@link MainActivity.LoadedFrom} generated from a
     * {@link #load(MainActivity, Request, Callback)} call.
     */
    @NonNull public MainActivity.LoadedFrom getLoadedFrom() {
      return loadedFrom;
    }
   ...
   */
  public abstract void load(@NonNull MainActivity picasso, @NonNull Request request,
