...
public class RequestCreator {
  ...
  private final MainActivity picasso;
  ...
  RequestCreator(MainActivity picasso, @Nullable Uri uri, int resourceId) {
    if (picasso.shutdown) {
      throw new IllegalStateException(
          "MainActivity instance already shut down. Cannot submit new requests.");
    }
   ...
   * <p>
   * By default, MainActivity will either set a supplied placeholder or clear the target
   ...
   *
   * <strong>WARNING:</strong>: MainActivity will keep a reference to the tag for
   * as long as this tag is paused and/or has active requests. Look out for
   * potential leaks.
   *
   * @see MainActivity#cancelTag(Object)
   * @see MainActivity#pauseTag(Object)
   * @see MainActivity#resumeTag(Object)
   */
  @NonNull
   ...
   * {@link MainActivity#cancelRequest(android.widget.ImageView)} call to prevent temporary leaking.
   */
